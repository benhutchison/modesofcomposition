...
import modesofcomposition.OrderProcessor.processAvailableOrder

object OrderProcessor {

  /** Consumes a stream of incoming JSON order messages, processing each concurrently */
  def processMsgStream[F[_]: Concurrent: Parallel: EventTime: UuidRef: SkuLookup: CustomerLookup: Inventory: Publish](
  ...
  def processMsg[F[_]: Sync: Parallel: EventTime: UuidRef: SkuLookup: CustomerLookup: Inventory: Publish](
  ...
  def processOrderMsg[F[_]: Sync: Parallel: EventTime: UuidRef: SkuLookup: CustomerLookup: Inventory: Publish](
